-- V2: Create package_cache table (event-sourced read cache of on-chain package state)
CREATE TABLE package_cache (
    ...
    CONSTRAINT uq_package_cache_key UNIQUE (chain_id, proxy_address, package_key)
);
